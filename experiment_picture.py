...
class ObjectDetector(object):
    ...
    def detect(self,image,annotate=None):
        ...
        for (x,y,xb,yb) in preds:
            ...
            cv2.putText(frame,'Distance = ' + str(distance) + ' Meters', (x+40,y-40),cv2.FONT_HERSHEY_SIMPLEX,1.0,(128,255,0),2)
...
while True:
    ...
    if len(results[2]) > 0:
        ...
        str_distance = str(distance) + ' Meters'
        ...
        for item in display_list:
            ...
            cv2.putText(frame, str_distance, (20,  150), item_font, 1.0, (255, 255, 255), 2)
